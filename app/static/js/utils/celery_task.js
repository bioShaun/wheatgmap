$(document).ready(function(){
  function connResult() {
    ...
    ajaxSend('/task/result/', {'task_id': taskId}, function(data){
      if (data.msg == 'ok'){
        layer.close(index);
...
function annTask(result){
  $('#result').empty();
  $('#result').html("<p><a class='btn btn-lg btn-primary' href='/static/download/vcf_ann/" + result + "' role='button'>download annotation zip files &raquo; </a></p>");
  return;
}

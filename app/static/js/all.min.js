...
function select_plugin(){var left_option_map={};$(".multi_d").multiselect({right:"#multi_d_to, #multi_d_to_2, #multi_d_to_3, #multi_d_to_4, #multi_d_to_5",rightSelected:"#multi_d_rightSelected, #multi_d_rightSelected_2, #multi_d_rightSelected_3, #multi_d_rightSelected_4, #multi_d_rightSelected_5",leftSelected:"#multi_d_leftSelected, #multi_d_leftSelected_2, #multi_d_leftSelected_3, #multi_d_leftSelected_4, #multi_d_leftSelected_5",rightAll:"#multi_d_rightAll, #multi_d_rightAll_2, #multi_d_rightAll_3, #multi_d_rightAll_4, #multi_d_rightAll_5",leftAll:"#multi_d_leftAll, #multi_d_leftAll_2, #multi_d_leftAll_3 #multi_d_leftAll_4, #multi_d_leftAll_5",search:{left:'<input type="text" name="q" class="form-control" placeholder="Search..." />',},moveToRight:function(Multiselect,$options,event,silent,skipStack){var button=$(event.currentTarget).attr("id");if(button=="multi_d_rightSelected"){var $left_options=Multiselect.$left.find("> option:selected");left_option_map[$left_options[0].value]=Multiselect.$left;Multiselect.$right.eq(0).append($left_options);if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(0).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(0));}}else if(button=="multi_d_rightAll"){var $left_options=Multiselect.$left.children(":visible");Multiselect.$right.eq(0).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(0).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(0));}}else if(button=="multi_d_rightSelected_2"){var $left_options=Multiselect.$left.find("> option:selected");Multiselect.$right.eq(1).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(1).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(1));}}else if(button=="multi_d_rightAll_2"){var $left_options=Multiselect.$left.children(":visible");Multiselect.$right.eq(1).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(1).eq(1).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(1));}}else if(button=="multi_d_rightSelected_3"){var $left_options=Multiselect.$left.find("> option:selected");Multiselect.$right.eq(2).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(2).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(2));}}else if(button=="multi_d_rightAll_3"){var $left_options=Multiselect.$left.children(":visible");Multiselect.$right.eq(2).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(2).eq(2).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(2));}}else if(button=="multi_d_rightSelected_4"){var $left_options=Multiselect.$left.find("> option:selected");Multiselect.$right.eq(3).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(3).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(3));}}else if(button=="multi_d_rightAll_4"){var $left_options=Multiselect.$left.children(":visible");Multiselect.$right.eq(3).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(3).eq(3).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(3));}}else if(button=="multi_d_rightSelected_5"){var $left_options=Multiselect.$left.find("> option:selected");Multiselect.$right.eq(4).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(4).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(4));}}else if(button=="multi_d_rightAll_5"){var $left_options=Multiselect.$left.children(":visible");Multiselect.$right.eq(4).append($left_options);left_option_map[$left_options[0].value]=Multiselect.$left;if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(4).eq(4).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(4));}}},moveToLeft:function(Multiselect,$options,event,silent,skipStack){var button=$(event.currentTarget).attr("id");if(button=="multi_d_leftSelected"){var $right_options=Multiselect.$right.eq(0).find("> option:selected");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftAll"){var $right_options=Multiselect.$right.eq(0).children(":visible");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftSelected_2"){var $right_options=Multiselect.$right.eq(1).find("> option:selected");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftAll_2"){var $right_options=Multiselect.$right.eq(1).children(":visible");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftSelected_3"){var $right_options=Multiselect.$right.eq(2).find("> option:selected");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftAll_3"){var $right_options=Multiselect.$right.eq(2).children(":visible");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftSelected_4"){var $right_options=Multiselect.$right.eq(3).find("> option:selected");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftAll_4"){var $right_options=Multiselect.$right.eq(3).children(":visible");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftSelected_5"){var $right_options=Multiselect.$right.eq(4).find("> option:selected");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}else if(button=="multi_d_leftAll_5"){var $right_options=Multiselect.$right.eq(4).children(":visible");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}},});}
function single_select_plugin(){var left_option_map={};var add_flag=true;$(".multi_d").multiselect({right:"#multi_d_to, #multi_d_to_2, #multi_d_to_3, #multi_d_to_4, #multi_d_to_5",rightSelected:"#multi_d_rightSelected, #multi_d_rightSelected_2, #multi_d_rightSelected_3, #multi_d_rightSelected_4, #multi_d_rightSelected_5",leftAll:"#multi_d_leftAll, #multi_d_leftAll_2, #multi_d_leftAll_3 #multi_d_leftAll_4, #multi_d_leftAll_5",search:{left:'<input type="text" name="q" class="form-control" placeholder="Search..." />',},moveToRight:function(Multiselect,$options,event,silent,skipStack){var button=$(event.currentTarget).attr("id");if(!add_flag){var $right_options=Multiselect.$right.eq(0).children(":visible");console.log($right_options);let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}
add_flag=true;}
if(button=="multi_d_rightSelected"){var $left_options=Multiselect.$left.find("> option:selected");left_option_map[$left_options[0].value]=Multiselect.$left;Multiselect.$right.eq(0).append($left_options);if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$right.eq(0).find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$right.eq(0));}}
add_flag=false;},moveToLeft:function(Multiselect,$options,event,silent,skipStack){var button=$(event.currentTarget).attr("id");if(button=="multi_d_leftAll"){var $right_options=Multiselect.$right.eq(0).children(":visible");let i=0;for(;i<$right_options.length;i++){left_option_map[$right_options[i].value].append($right_options[i]);}
if(typeof Multiselect.callbacks.sort=="function"&&!silent){Multiselect.$left.find("> option").sort(Multiselect.callbacks.sort).appendTo(Multiselect.$left);}}
add_flag=true;},});}
function clear_select_plugin(){var multi_select_box1=$("#multi_d");var multi_select_box2=$("#multi_d2");var multi_select_to_box=$("#multi_d_to");multi_select_box2.click(function(){multi_select_box1.val([]);multi_select_to_box.val([]);});multi_select_box1.click(function(){multi_select_box2.val([]);multi_select_to_box.val([]);});}
...
var plotInfo={gene_name:gene_ids,xlabel:xlabel,series:series,};return plotInfo;}
function createAlert(msg,type){if(!type){type="alert-danger";}
...
"&times;</button>"+
msg+
"</div>";$(alertStr).appendTo($(".myalert"));}
function generate_result_param_line(params,item){if(params[item].length){item_info=params[item].join(", ");return`<div><code>${item}</code><p style="word-break: break-word;">${item_info}</p></div>`;}else{return"";}}
function createPlot(files,name,params){console.log(params);paramsObj=JSON.parse(params);var textStr="<div class='col-md-4'>"+

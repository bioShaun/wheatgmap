...
return href_str;}
function createTable(headData,bodyData,tableType){var htmlBuffer=[];htmlBuffer.push('<table id="example" class="table table-striped table-bordered table-hover" width="100%">');htmlBuffer.push("<thead>\n<tr>");for(var i=0;i<headData.length;i++){htmlBuffer.push("<th>"+headData[i]+"</th>");}
...
return"";}
function addExample(inputId="genes",linkId="gene-example-link",exampleGene="TraesCS1D02G311400"){$(`#${linkId}`).click(function(){$(`#${inputId}`).val(exampleGene);});}/*! layer-v3.1.1 Web弹层组件 MIT License  http://layer.layui.com/  By 贤心 */

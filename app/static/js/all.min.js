...
function createPlot(files,name){var textStr="<div class='col-md-4'><h3>Snp Score Plot</h3>"+
"<p>snp Score plot by group.</p>"+
"<p><a class='btn btn-primary' href='"+
name+
"' role='button'>Download &raquo;</a></p>"+
"</div>";var plotStr="<div class='col-md-8 albumSlider'>"+
...
files[i]+
"'></a></li>");}
var liStr=liBuffer.join("\n");plotStr=plotStr+"<ul class='imglist'>"+liStr+"</ul></div></div></div>";var allStr="<div class='row'>"+textStr+plotStr+"</div>";return allStr;}

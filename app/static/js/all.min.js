...
$.ajax(params);}
function createHref(gene){if(gene.split('-').length==2){gene_array=gene.split('-');href_str1="<a href='/tools/gene/information/?gene="+gene_array[0]+"'>"+gene_array[0]+"</a>";href_str2="<a href='/tools/gene/information/?gene="+gene_array[1]+"'>"+gene_array[1]+"</a>";href_str=href_str1+'\n'+href_str2;}else{href_str="<a href='/tools/gene/information/?gene="+gene+"'>"+gene+"</a>";}
return href_str;}
...
"<p><a class='btn btn-primary' href='"+name+"' role='button'>Download &raquo;</a></p>"+"</div>";var plotStr="<div class='col-md-8 albumSlider'>"+
...
$(window).scroll(function(){if(scrollY+windowHeight===documentHeight){$("#footer").fadeIn();}else{$("#footer").hide();}});}/*! layer-v3.1.1 Web弹层组件 MIT License  http://layer.layui.com/  By 贤心 */

...
"'></a></li>");}
var liStr=liBuffer.join('\n');plotStr=plotStr+"<ul class='imglist'>"+liStr+"</ul></div></div></div>";var allStr="<div class='row'>"+textStr+plotStr+"</div>";return allStr;}/*! layer-v3.1.1 Web弹层组件 MIT License  http://layer.layui.com/  By 贤心 */
